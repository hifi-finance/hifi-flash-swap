...
import { CHAINLINK_PRICE_PRECISION, H_TOKEN_DECIMALS, TEN, USDC_DECIMALS, WBTC_DECIMALS } from "./constants";

export function getWholeHUsdcAmount(amount: BigNumberish): BigNumber {
  return BigNumber.from(amount).mul(TEN.pow(H_TOKEN_DECIMALS));
}
